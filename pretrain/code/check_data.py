...
if __name__ == "__main__":
    data = json.load(open("../data/CP/datalawyer/cpdata.json", encoding='utf8', mode='r'))
    ...
    json.dump(list_data, open("../data/CP/datalawyer/cpdata_dedup.json", mode="w", encoding='utf8'))
    json.dump(rel2scope, open("../data/CP/datalawyer/rel2scope.json", mode="w", encoding='utf8'))
